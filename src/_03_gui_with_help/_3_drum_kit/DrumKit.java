...
public class DrumKit implements MouseListener {
	...
	public void run() {
		...
		String drumImg = "snare.jpg";
		//  Edit the next line to use your String variable
		drumLabel = createLabelImage(drumImg);
		...
		String cymImg = "cymbal.jpg";
		cymbalImg = createLabelImage(cymImg);
		panel.add(cymbalImg);
		cymbalImg.addMouseListener(this);
	...
	public void mouseClicked(MouseEvent e) {
		...
		else if (labelClicked == cymbalImg) {
